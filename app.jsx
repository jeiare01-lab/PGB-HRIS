    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-3xl p-8 mb-8 shadow-2xl">
          ...
          <p className="text-xl">CMG Pilot • PSC • ABC • CSI • Philippine Peso (₱)</p>
        </div>
        ...
        {activeTab === 1 && (
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-green-400 to-emerald-600 text-white rounded-2xl p-6 shadow-lg">
                <p className="text-white/80 text-sm">Time-to-Fill</p>
                <p className="text-5xl font-black mt-3">35 days</p>
              </div>
              <div className="bg-gradient-to-br from-emerald-400 to-teal-600 text-white rounded-2xl p-6 shadow-lg">
                <p className="text-white/80 text-sm">Quality-of-Hire</p>
                <p className="text-5xl font-black mt-3">87%</p>
              </div>
              <div className="bg-gradient-to-br from-teal-400 to-cyan-600 text-white rounded-2xl p-6 shadow-lg">
                <p className="text-white/80 text-sm">Cost-per-Hire</p>
                <p className="text-4xl font-black mt-3">₱35,000</p>
              </div>
            </div>
            <div className="bg-gradient-to-br from-green-100 to-emerald-200 rounded-2xl p-8 border-3 border-green-400 shadow-lg">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div><p className="text-5xl font-black text-green-700">15</p><p className="text-green-800 font-bold">Open PRFs</p></div>
                <div><p className="text-5xl font-black text-emerald-700">120</p><p className="text-emerald-800 font-bold">Candidates</p></div>
                <div><p className="text-5xl font-black text-teal-700">5</p><p className="text-teal-800 font-bold">Final Round</p></div>
              </div>
            </div>
          </div>
        )}
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-orange-200 rounded-2xl p-8 border-3 border-yellow-400 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-5xl font-black text-orange-900 mt-2">+0-15%</p>
